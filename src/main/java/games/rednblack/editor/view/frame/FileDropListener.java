...
package games.rednblack.editor.view.frame;
...
//TODO remove after migrate to Drag listener in LWJGL3
public class FileDropListener implements DropTargetListener {

    private static final String CLASS_NAME = "games.rednblack.editor.view.frame.FileDropListener";
