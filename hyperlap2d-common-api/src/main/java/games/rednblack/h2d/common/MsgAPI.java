...
public class MsgAPI {
     ...
     */
    public static final String SANDBOX_PREFIX = "games.rednblack.editor.gdx.commands.Sandbox";
    ...
    public static final String ACTION_UPDATE_POLYGON_VERTEX_POSITION = SANDBOX_PREFIX + "ACTION_UPDATE_POLYGON_VERTEX_POSITION";
