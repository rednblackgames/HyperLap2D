...
public class ParallelActionBoxProducer extends GraphBoxProducerImpl<ActionFieldType> {

    public ParallelActionBoxProducer() {
        super(new ParallelActionNodeConfiguration());
    }

    @Override
    public GraphBoxImpl<ActionFieldType> createPipelineGraphBox(Skin skin, String id, JSONObject data) {
        GraphBoxImpl<ActionFieldType> graphBox = createPipelineGraphBoxConfig(skin, id, new ParallelActionNodeConfiguration());
