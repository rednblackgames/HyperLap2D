...
import games.rednblack.editor.event.ClickNotifier;


/**
 * Created by azakhary on 4/28/2015.
 */
public class PhysicsEditorDialog extends H2DDialog {

    public static final String PREFIX = "games.rednblack.editor.view.ui.dialog.PhysicsEditorDialog";
