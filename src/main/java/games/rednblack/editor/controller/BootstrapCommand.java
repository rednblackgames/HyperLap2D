...
public class BootstrapCommand extends SimpleCommand {
	...
	public void execute(INotification notification) {
        ...
        facade.registerCommand(MsgAPI.ACTION_SET_ENTITY_Z_INDEX, SetEntityZIndexCommand.class);
        facade.registerCommand(MsgAPI.ACTION_REORDER_Z_INDEX, ReorderItemsZIndexCommand.class);
        facade.registerCommand(MsgAPI.ACTION_SET_ENTITY_LAYER, SetEntityLayerCommand.class);
